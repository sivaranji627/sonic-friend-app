...
export const MusicPlayer = ({ 
  ...
  if (!currentTrack) {
    return (
      <div className="fixed bottom-0 left-0 right-0 bg-gradient-card border-t border-border p-4 shadow-player">
        <div className="flex items-center justify-center text-muted-foreground">
          <p className="text-sm">🎵 Choose a song to start your musical journey!</p>
        </div>
      </div>
    );
  }
